...
class OperatorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create operator" do
    assert_difference('Operator.count') do
      post operators_url, params: { operator: { drone_type: @operator.drone_type, name: @operator.name, scenario: @operator.scenario } }
    end
  ...
  test "should update operator" do
    patch operator_url(@operator), params: { operator: { drone_type: @operator.drone_type, name: @operator.name, scenario: @operator.scenario } }
